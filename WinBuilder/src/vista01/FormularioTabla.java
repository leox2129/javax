...
public class FormularioTabla extends JFrame {
	...
	//private A
	private enumerado.Modo modoForm;
	private int filaSel;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormularioTabla frame = new FormularioTabla();
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					case NORMAL:
						...
						modoForm = Modo.EDIT;
						btnEditar.setText("Editando:  "+persona.getId());
						break;
					case EDIT:
						modoForm= Modo.NORMAL;
						btnEditar.setText("Editar");
						//modoficar el array lista de perosnas						
						//llamar al metodo actulizar
